...
static jobject	g_audio_record;
static jclass 	g_record_class;
...
static int PJ_THREAD_FUNC AndroidRecorderCallback(void* userData){
	...
	PJ_LOG(4, (THIS_FILE, "sxsexe CallVoidMethod startRecording"));
...
*/
	...
	if (stream->dir & PJMEDIA_DIR_CAPTURE) {
		//Get pointer to the java class
		stream->record_class = g_record_class;
