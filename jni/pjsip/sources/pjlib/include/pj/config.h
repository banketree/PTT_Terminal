...
#   define PJ_LINUX	    1
//zzc add for mips
#if defined(PJ_M_MIPS) || defined(__mips__) || defined(__mips) || \
    defined(__MIPS__) || defined(MIPS) || defined(_MIPS_)
#   undef PJ_LINUX
#   define PJ_LINUX         0
#endif
//zzc add for arm
#if defined (PJ_M_ARMV4) || defined(ARM) || defined(_ARM_) ||  \
...
#   define PJ_HAS_PENTIUM	0
#   define PJ_IS_LITTLE_ENDIAN  1 //zzc add
#   define PJ_IS_BIG_ENDIAN     0 //zzc add
