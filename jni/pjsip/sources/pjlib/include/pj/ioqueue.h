...
/**
 * zzc add for multi network switch.
 *
 * @param ioque		    the I/O Queue.
 * @param bind_addr	    sock address to bind.
 *
 * @return              PJ_SUCCESS if rebuild socket successfully.
 */
PJ_DECL(pj_status_t) sock_bind_device(pj_ioqueue_t *ioque, char *bind_addr);
