/* $Id: sip_inv.c 3878 2011-10-31 10:31:23Z ming $ */
/* 
					    ...
					    pjsip_tx_data **p_tdata )
{
	...
	if (inv->role == PJSIP_ROLE_UAC) {
		...
		*p_tdata = NULL;
        ...
        inv->cause = 0;
        st_text = NULL;
        inv_set_cause(inv, PJSIP_SC_BUSY_HERE, st_text);
	    status = pjsip_inv_answer(inv, PJSIP_SC_BUSY_HERE, st_text, NULL, &tdata);
	}
	break;
